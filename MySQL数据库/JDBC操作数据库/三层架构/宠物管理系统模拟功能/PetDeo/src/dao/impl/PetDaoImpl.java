...
public class PetDaoImpl extends BaseDao implements PetDao{
	...
	public int addPet(Pet pet) {
		String sql ="INSERT INTO pet (id,NAME,health,love,strain,masterid) VALUES (DEFAULT,?,?,?,?,?)";
		Object[] params= {pet.getName(),pet.getHealth(),pet.getLove(),pet.getStrain(),pet.getMasterid()};
		int result =-1;
		try {
	...
	public List<Pet> findAllPetByMasterId(int masterid) {
		...
		try {
			String sql = "SELECT id,`name`,health,love,strain,masterid FROM pet WHERE masterid=?";
